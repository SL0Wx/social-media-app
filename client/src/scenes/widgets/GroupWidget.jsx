import { ManageAccountsOutlined, AutoAwesome } from "@mui/icons-material";
            ...
            <FlexBetween gap="0.5rem" pb="1.1rem">
                <FlexBetween gap="1rem">
                    ...
                    <Box>
                        ...
                        <Typography color={medium}>{members.length} {members.length > 1 ? "Członków" : (members.length == 1 ? "Członek" : "Członków")}</Typography>
                    </Box>
                </FlexBetween>
            </FlexBetween>
